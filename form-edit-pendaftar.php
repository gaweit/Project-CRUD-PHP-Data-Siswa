...
<body style="font-family: monospace;">
    ...
    <center>
        ...
        <form action="proses-edit-data.php" method="POST">
            ...
            <fieldset
                style="width: 390px; height: 220px; padding: 20px; border:2px solid green; box-shadow:0 0 10px #999;">
                <table border=0>
                    <tr>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td valign="center">:</td>
                        <td valign="center"><input size="36" type="text" name="nama" placeholder="nama lengkap"
                                value="<?php echo $siswa['nama'] ?>" /></td>
                    </tr>
                    <tr>
                        <td width="200" valign="top"><label for="alamat">Alamat </label></td>
                        <td valign="top">:</td>
                        <td valign="top"><textarea rows="4" cols="25,99"
                                name="alamat"><?php echo $siswa['alamat'] ?></textarea></td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <label><input type="radio" name="jenis_kelamin" value="Laki-laki"
                                    <?php echo ($jk == 'Laki-laki') ? "checked": "" ?>> Laki-laki</label><br>
                    ...
                    <tr>
                        ...
                        <td valign="center">:</td>
                        <td valign="center"><input size="36" type="text" name="sekolah_asal" placeholder="asal sekolah"
                                value="<?php echo $siswa['sekolah_asal'] ?>" /></td>
                    </tr>
                    <tr>
                        <td width="200" valign="top"></label></td>
                        <td valign="top"></td>
                        <td valign="top"><input style="margin-top:10px; height:25px; width:120px" height="200"
                                type="submit" type="submit" value="Ubah & Simpan" name="simpan" /></td>
                    </tr>
                </table>
            </fieldset>
        </form>
        ...
        <a href="list-database.php">[---] Kembali ke Data List Pendaftar</a>&nbsp;|&nbsp;<a href="index.php">[^] Ke
            Halaman Utama</a>
        &nbsp;
    </center>
</body>
